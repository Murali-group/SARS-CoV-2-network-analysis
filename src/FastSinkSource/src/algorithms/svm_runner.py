...
import src.algorithms.logistic_regression_runner as logReg_runner
import src.algorithms.svm as svm
import time


def setupInputs(run_obj):
    # use the same steps as are used for logistic regression
    logReg_runner.setupInputs(run_obj) 
    return 
...
def run(run_obj):
    ...
    for term in tqdm(run_obj.terms_to_run):    
        ...
        clf = svm.training(X_train, lab, max_iters)
